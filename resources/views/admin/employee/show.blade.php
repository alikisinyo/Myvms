                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card">
                        ...
                        <div class="profile-widget-description profile-widget-employee">
                            <dl class="row">
                            <dt class="col-sm-4">{{ __('Svc_no') }}</dt>
                            <dd class="col-sm-8">{{ $employee->user->svc_no }}</dd>
                            <dt class="col-sm-4">{{ __('Rank') }}</dt>
                            <dd class="col-sm-8">{{ $employee->user->rank }}</dd>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="preregistertable"
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col">{{ __('levels.svc_no') }}</th>
                                                <th scope="col">{{ __('levels.rank') }}</th>
