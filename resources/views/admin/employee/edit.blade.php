                        ...
                        <form action="{{ route('admin.employees.update', $employee) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col">
                                        <label for="svc_no">{{ __('Svc_no') }}</label> <span class="text-danger">*</span>
                                        <input id="svc_no" type="text" name="svc_no" class="form-control {{ $errors->has('svc_no') ? " is-invalid " : '' }}" value="{{ old('svc_no') }}">
                                        @error('svc_no')
                                    ...
                                    <div class="form-group col">
                                        <label for="rank">{{ __('Rank') }}</label> <span class="text-danger">*</span>
                                        <input id="rank" type="text" name="rank" class="form-control {{ $errors->has('rank') ? " is-invalid " : '' }}" value="{{ old('rank ') }}">
                                        @error('rank')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
