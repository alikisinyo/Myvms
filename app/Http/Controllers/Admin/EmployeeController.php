    ...
    public function getEmployees(Request $request)
    {
        $employees = $this->employeeService->all();
            ...
            return Datatables::of($employeeArray)
                ...
                ->editColumn('svc_no', function ($employee) {
                    return Str::limit($employee->svc_no, 50);
                })
                ->editColumn('rank', function ($employee) {
                    return Str::limit($employee->rank, 50);
                })
